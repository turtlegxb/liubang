...
def generate_signal_report(
    ...
    *,
    ...
    return {
        ...
        "position_limits": {
            "weak": params.weak_max_positions,
            "neutral": params.neutral_max_positions,
            "strong": params.strong_max_positions,
        },
        "replacement_policy": {
            "mode": params.reselection_exit_mode,
            "min_hold_score": params.replacement_min_hold_score,
            "min_candidate_score_margin": params.replacement_min_candidate_score_margin,
            "candidate_score_mode": params.replacement_score_mode,
            "compare_mode": params.replacement_compare_mode,
            "note": "Recorded for live/paper observation; manual orders are still controlled by the operator.",
        },
    ...
    *,
    ...
    return {
        ...
        "filters": {
            ...
            "position_limits": report.get("position_limits") or {},
            "replacement_policy": report.get("replacement_policy") or {},
        },
